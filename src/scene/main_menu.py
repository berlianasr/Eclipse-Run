...
SUN_WALK_A = os.path.join(CHARACTERS_DIR, "sun", "sun_walk_a.png")
SUN_WALK_B = os.path.join(CHARACTERS_DIR, "sun", "sun_walk_b.png")
MOON_WALK_A = os.path.join(CHARACTERS_DIR, "moon", "moon_walk_a.png")
MOON_WALK_B = os.path.join(CHARACTERS_DIR, "moon", "moon_walk_b.png") 

TARGET_TITLE_WIDTH = 500
# Move title down and increase size
TITLE_Y_POSITION = 80 
...
class MainMenuScreen(BaseScreen):
    ...
    def draw(self, surface: pygame.Surface):
        ...
        # 3. ukuran karakter berdasarkan tinggi tombol (sedikit lebih besar)
        ...
        # 5. Gambar karakter moon di kanan
